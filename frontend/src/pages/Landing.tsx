...
const BeforeAfterSlider = () => {
  ...
  useEffect(() => {
    // Create DOM-compatible event handlers
...
const TemplateExample = () => {
  ...
  // Define a type for model content
  ...
  const modelContent: ModelContentType = {
      ...
      <Grid item xs={12} md={7}>
        <Paper sx={{ 
          ...
          <Box>
            ...
            {selectedContent.points.map((point: any, index: number) => (
